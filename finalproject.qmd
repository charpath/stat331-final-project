...
Now that we've been able to take a look at a visual, let's see if we can fit a linear regression model to predict the murders per 100,000 based on the unemployment rate. In this case, murders per 100,000 will be our response variable, and unemployment rate will be our explanatory variable.
