...
With the clean data, we will now compare the relationship between the two. Unemployment will be our explanatory variable, while murder will be our response variable.
### Visual Plots
...
murders_unemployment |>
  ...
  labs(title = "Linear Regression Unemployment rate Vs. Murder",
