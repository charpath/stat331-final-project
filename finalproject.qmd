...
murders_unemployment |>
  ...
  labs(title = "Relationship Between Murder and Unemployment Rates in Different Countries (1990 - 2016)",
       x = "Unemployment Rate (%)",
...
Now lets look at how well a linear model fits our data. We can find out by calculating the variation in our response variable (murders per 100,000), the fitted model values and residuals. 
